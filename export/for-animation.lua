...
--
-- Save and edit cel anchor points for every frame of a spritesheet animation.
-- Export a single png with size-optimal packing options.
-- Export an accompanying animation and texture atlas JSON.
-- Animation data includes frame duration and cel anchor points.
...
function export_cel(cel, voff, hoff)
    local data = {
        ...
        duration = cel.frame.duration * 1000
    }
    return data
  end
